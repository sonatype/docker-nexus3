...
ARG NEXUS_DOWNLOAD_URL=https://jenkins.ci.sonatype.dev/job/nxrm/job/nxrm3/job/release/lastSuccessfulBuild/artifact/target/dist/nexus-3.63.0-01-unix.tar.gz
